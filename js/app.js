              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                    <img  <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" alt="User Picture" /> alt="User Picture" />
                  </a>
...
const displayReportedPosts = () => {
    ...
    reportedPosts.forEach((reportedPost) => {
        const div = createPost(reportedPost);
